...
namespace NettoyerCommentaireCodeVB
{
    public partial class Form1 : Form
    {
        ...
        {
            openFileDialog1.Filter = "Fichiers VB.NET|*.vb";
        ...
        private void CmdCascade_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            List<string> lstFichiers = new List<string>(Directory.EnumerateFiles(Chemin, "*.vb", SearchOption.AllDirectories));
