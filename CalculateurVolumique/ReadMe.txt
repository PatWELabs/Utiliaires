================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet CalculateurVolumique
===============================================================================

L'Assistant Application a créé cette application CalculateurVolumique pour  
...
constituent votre application CalculateurVolumique.

CalculateurVolumique.vcproj
...
d'autres 
    ...
    classe d'application CCalculateurVolumiqueApp.

CalculateurVolumique.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CCalculateurVolumiqueApp.

CalculateurVolumique.rc
...
res\CalculateurVolumique.ico
    Il s'agit d'un fichier icône, qui est utilisé comme icône de l'application.  
Cette 
    icône est incluse par le fichier de ressource principal CalculateurVolumique.rc.

res\CalculateurVolumique.rc2
...
CalculateurVolumiqueDlg.h, CalculateurVolumiqueDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CCalculateurVolumiqueDlg.  Cette classe 
définit 
    le comportement de la boîte de dialogue principale de votre application.  Le 
modèle de boîte de dialogue se trouve 
    dans CalculateurVolumique.rc et peut être modifié dans Microsoft Visual 
C++.
...
(PCH) 
    nommé CalculateurVolumique.pch et un fichier de type précompilé nommé 
Stdafx.obj.
