=================================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet Time2Deca
=================================================================================================

AppWizard a créé cette application Time2Deca à votre attention. Cette application
...
res\Time2Deca.ico
    ...
    est incluse dans le fichier de ressources principal Time2Deca.rc.
...
Time2DecaDlg.h, Time2DecaDlg.cpp - la boîte de dialogue
    Ces fichiers contiennent votre classe CTime2DecaDlg, qui définit le
    comportement de la boîte de dialogue principale de votre application. Le modèle de boîte de
    dialogue se trouve dans le fichier Time2Deca.rc, modifiable dans Microsoft Visual C++.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    ...
    appelé Time2Deca.pch, et un fichier de types précompilés StdAfx.obj.
